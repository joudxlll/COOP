...
/// </summary>
/// 
namespace joud4400Project.App_Code
{
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["vaultKeeperConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["vaultKeeperConStr"].ConnectionString);
        public CRUD()
        {
            //
